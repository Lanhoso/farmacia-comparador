"""
ahumada.py — Scraper da Farmacias Ahumada para farmaciabarata.cl
...
TODO (para implementar):
    1. Inspecionar o DOM de https://www.farmaciasahumada.cl com debug_scraper.py
...
SEARCH_URL = "https://www.farmaciasahumada.cl/buscar?q={query}"  # Placeholder — confirmar URL real
...
class AhumadaScraper(BaseScraper):
    """Scraper da Farmacias Ahumada — https://www.farmaciasahumada.cl"""

    def __init__(self) -> None:
        super().__init__(farmacia_id="ahumada")

    async def scrape(self, query: str) -> list[dict]:
        """
        TODO: Implementar scraping da Ahumada com Playwright.
        ...
        raise NotImplementedError(
            "AhumadaScraper.scrape() ainda não implementado. "
            "Ver TODO em scrapers/ahumada.py"
        )
